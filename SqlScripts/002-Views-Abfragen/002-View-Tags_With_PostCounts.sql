...
-- Beschreibung:	Diese View liefert eine Übersicht über die Anzahl der Blog-Posts pro Tag.
--					Die Tags werden nach ihrer Häufigkeit in den Blog-Posts gruppiert und gezählt.
...
SELECT
	...
	dbo.Tags.tag_name,
	COUNT(dbo.PostTags.post_id) AS post_count -- Die Anzahl der Blog-Posts für diesen Tag
FROM            
	dbo.PostTags 
INNER JOIN
    dbo.Tags 
